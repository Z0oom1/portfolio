...
export default function CartaoVisita() {
  ...
  return (
    <section className="py-20 px-4 flex flex-col items-center justify-center bg-[#111]">
      <div className="text-[rgba(242,242,242,0.6)] mb-8 text-sm tracking-[0.2em] uppercase animate-pulse">
        Clique no cartão para girar
      </div>

      <div 
        className="w-[950px] h-[550px] cursor-pointer"
      ...
      >
        ...
        >
          ...
          {/* Back Card */}
          <div
            className="absolute w-full h-full flex bg-[#030303] overflow-hidden"
            style={{
              backfaceVisibility: 'hidden',
